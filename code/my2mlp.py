...
def test_mlp(learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=1000,
             dataset='mnist.pkl.gz', batch_size=20, n_hidden1=500,n_hidden2=100):
    """
   ...
   """
    ...
    classifier = MLP(rng=rng, input=x, n_in=28 * 28,
                     n_hidden1=n_hidden1, n_hidden2=n_hidden2, n_out=10)
...
if __name__ == '__main__':
    test_mlp(n_epochs = 100, n_hidden1 = 2000, n_hidden2=500, L2_reg=0.00001)
